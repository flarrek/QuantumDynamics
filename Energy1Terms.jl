...
abstract type Energy1Term <: EnergyTerm end # comprises various possible one-body energy terms of the system Hamiltonian.



struct CustomEnergy1Term <: Energy1Term
    # represents arbitrary one-body energy terms for the given particle groups, specified by involved properties and form.
